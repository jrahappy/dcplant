...
class PatientAdmin(admin.ModelAdmin):
    list_display = ('mrn', 'full_name', 'age', 'gender', 'organization', 'consent_given', 'created_at')
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('mrn', 'first_name', 'last_name', 'date_of_birth', 'gender', 'age')
        }),
        ('Contact Information', {
...
class CaseAdmin(admin.ModelAdmin):
    list_display = ('case_number', 'patient_name', 'category', 'status_badge', 'priority_badge', 
                    'organization', 'assigned_to', 'created_at')
    list_filter = ('status', 'priority', 'category', 'organization', 'is_shared', 
                   'is_deidentified', 'created_at')
    search_fields = ('case_number', 'patient__first_name', 'patient__last_name', 
                     'patient__mrn', 'chief_complaint', 'diagnosis')
    ...
    fieldsets = (
        ...
        ('Clinical Details', {
            'fields': ('chief_complaint', 'clinical_findings', 'diagnosis', 
                      'treatment_plan', 'prognosis')
        }),
        ('Assignment', {
            'fields': ('organization', 'created_by', 'assigned_to')
        }),
        ('Sharing', {
...
class CaseImageAdmin(admin.ModelAdmin):
    list_display = ('title', 'case', 'image_type', 'is_primary', 'is_deidentified', 
...
class CaseActivityAdmin(admin.ModelAdmin):
    list_display = ('case', 'activity_type', 'user', 'description', 'ip_address', 'created_at')
    list_filter = ('activity_type', 'created_at')
    search_fields = ('case__case_number', 'user__username', 'description')
    readonly_fields = ('case', 'user', 'activity_type', 'description', 'metadata', 
