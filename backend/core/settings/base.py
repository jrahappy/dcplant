...
SPECTACULAR_SETTINGS = {
    'TITLE': 'DCPlant API',
    'DESCRIPTION': 'Dental franchise case-sharing platform API',
    'VERSION': '1.0.0',
...
AWS_STORAGE_BUCKET_NAME = config('AWS_STORAGE_BUCKET_NAME', default='dcplant-dev')
...
DATA_UPLOAD_MAX_NUMBER_FILES = 100  # Allow up to 100 files in a single upload
FILE_UPLOAD_MAX_MEMORY_SIZE = 10 * 1024 * 1024  # 10MB per file
DATA_UPLOAD_MAX_MEMORY_SIZE = 100 * 1024 * 1024  # 100MB total upload size